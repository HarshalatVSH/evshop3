...
import { signInForm } from "./helperApi";
...
function LoginForm(props) {
  ...
  const usenameInputStyles = {
    background:
      hoverValue === "username" ? "rgb(237,237, 237)" : "rgb(247,247, 247)",
    borderTop: "none",
    borderRight: "none",
    borderLeft: "none",
    borderImage: "initial",
    borderBottom:
      hoverValue === "username"
        ? "1px solid black"
        : hoverValue === "user_change" && identifier
        ? "1px solid rgb(60, 152, 199)"
        : "1px solid rgb(197, 197, 197)",
  ...
  const passwordDivStyles = {
    background:
      hoverValue === "password" ? "rgb(237,237, 237)" : "rgb(247,247, 247)",
    borderTop: "none",
    borderRight: "none",
    borderLeft: "none",
    borderImage: "initial",
    borderBottom:
      hoverValue === "password"
        ? "1px solid black"
        : hoverValue === "pass_change" && password
        ? "1px solid rgb(60, 152, 199)"
        : "1px solid rgb(197, 197, 197)",
    borderRadius: "3px 3px 0px 0px",
    color: "rgb(37, 37, 37)",
  ...
  return (
    <section className="panel" id="popup" style={popupStyles}>
      ...
      <main className="panel-body" style={panelBody}>
        <form
          ...
          onSubmit={async (e) => {
            ...
            const signIn = async (identifier, password) => {
              const res = await signInForm(identifier, password);
        ...
        >
          {error ? (
            <ErrorAlert style={FormValidation} className="form-error">
